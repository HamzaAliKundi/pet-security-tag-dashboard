            ...
            <div className="relative bg-white rounded-xl shadow-lg border border-gray-200 max-w-sm w-full px-6 py-6 flex flex-col items-center animate-fade-in mx-4">
              ...
              <div className="flex gap-3 w-full mt-2 px-2">
                ...
                <button
                  ...
                  className="flex-1 h-9 rounded-md bg-red-600 text-white hover:bg-red-700 transition-all duration-200 flex items-center justify-center disabled:opacity-50 font-semibold text-xs"
                  disabled={isLoggingOut}
                >
                  {isLoggingOut ? (
