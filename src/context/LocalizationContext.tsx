...
const SHIPPING_PRICES: Record<string, { amount: number; currency: string; symbol: string }> = {
  ...
  DE: { amount: 2.99, currency: 'GBP', symbol: '£' },
  FR: { amount: 2.99, currency: 'GBP', symbol: '£' },
  IT: { amount: 2.99, currency: 'GBP', symbol: '£' },
  ES: { amount: 2.99, currency: 'GBP', symbol: '£' },
  NL: { amount: 2.99, currency: 'GBP', symbol: '£' },
  BE: { amount: 2.99, currency: 'GBP', symbol: '£' },
  AT: { amount: 2.99, currency: 'GBP', symbol: '£' },
  CH: { amount: 2.99, currency: 'GBP', symbol: '£' },
  SE: { amount: 2.99, currency: 'GBP', symbol: '£' },
  NO: { amount: 2.99, currency: 'GBP', symbol: '£' },
  DK: { amount: 2.99, currency: 'GBP', symbol: '£' },
  FI: { amount: 2.99, currency: 'GBP', symbol: '£' },
  IE: { amount: 2.99, currency: 'GBP', symbol: '£' },
  PT: { amount: 2.99, currency: 'GBP', symbol: '£' },
  PL: { amount: 2.99, currency: 'GBP', symbol: '£' },
  GR: { amount: 2.99, currency: 'GBP', symbol: '£' },
  CZ: { amount: 2.99, currency: 'GBP', symbol: '£' },
  HU: { amount: 2.99, currency: 'GBP', symbol: '£' },
  RO: { amount: 2.99, currency: 'GBP', symbol: '£' },
  BG: { amount: 2.99, currency: 'GBP', symbol: '£' },
  HR: { amount: 2.99, currency: 'GBP', symbol: '£' },
  SK: { amount: 2.99, currency: 'GBP', symbol: '£' },
  SI: { amount: 2.99, currency: 'GBP', symbol: '£' },
  EE: { amount: 2.99, currency: 'GBP', symbol: '£' },
  LV: { amount: 2.99, currency: 'GBP', symbol: '£' },
  LT: { amount: 2.99, currency: 'GBP', symbol: '£' },
  LU: { amount: 2.99, currency: 'GBP', symbol: '£' },
  MT: { amount: 2.99, currency: 'GBP', symbol: '£' },
  CY: { amount: 2.99, currency: 'GBP', symbol: '£' },
}

// Default shipping price (GBP)
const DEFAULT_SHIPPING = { amount: 2.99, currency: 'GBP', symbol: '£' }
